...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        <!-- โลโก้ของเว็บไซต์ -->
        <a class="navbar-brand" href="major_dashboard.php">
            <img src="../logo-banner-alumni.png" alt="Logo">
        </a>
        <!-- ปุ่มสำหรับหน้าจอมือถือ -->
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavMajor"
            aria-controls="navbarNavMajor" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
        </button>
        <!-- ลิงก์เมนู -->
        <div class="collapse navbar-collapse" id="navbarNavMajor">
            <ul class="navbar-nav mx-auto">
                <!-- หน้าแรก -->
                <li class="nav-item">
                    <a class="nav-link <?= ($current_page == 'major_dashboard.php') ? 'active' : '' ?>"
                        href="major_dashboard.php">หน้าแรก</a>
                </li>
